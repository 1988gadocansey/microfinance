...
<div id="page_content">
        ...
        <h6 class="heading_b uk-margin-bottom">Customers</h6>
         ...
         <div style="" class="">
            ...
            <div class="uk-margin-bottom" style="" >
                <a  href="#new_task" data-uk-modal="{ :true }"> <i title="click to send sms to students"   class="material-icons md-36 uk-text-success"   >phonelink_ring  </i></a>
 ...
 <div class="uk-overflow-container" id='print'>
 					 <center><h5>ACCOUNT INFORMATION AS AT <%java.text.DateFormat df = new java.text.SimpleDateFormat("yyyy"); %> </h5></center>
     <hr>
    ...
    <table   class="uk-table uk-table-nowrap " >
       ...
       <tr>
          <td width="210" class="uppercase" align="right"><strong>ACCOUNT N<u>O</u></strong></td>
          <td width="408" class="capitalize">${client.number}</td>								
       </tr>
        <tr>
          <td class="uppercase" align="right"><strong>ACCOUNT TYPE:</strong></td>
          <td class="capitalize">${client.type}</td>
        </tr>
         <tr>
        ...
        <tr>
          <td class="uppercase" align="right"><strong>ACCOUNT BALANCE  </td>
          <td class="capitalize">GHC$0.00</td>
        </tr>
             ...
             <td valign="top" >
                      <td>  <img   style="width: 275px;height: auto;margin-top:-52px" src="${pageContext.request.contextPath}/photos/customers/gad.jpg" alt="user avatar"/></td>
                                             
           </td>
   
         </tr>
     </table>
     <fieldset class=""><legend class="uk-text-bold heading_c">TRANSACTIONS THIS MONTH</legend>
      <table>
          <tr>
              <td>
                  <table>
