...
<div id="page_content">
    <div id="page_content_inner">
         <h6 class="heading_a uk-margin-bottom">Account Deposit</h6> 
        ...
        <div class="uk-width-xLarge-1-10">
           ...
           <form id='form' method="POST" action="/transactions/accounts/deposit" accept-charset="utf-8"  name="applicationForm"  v-form>
                ...
                <div class="uk-width-medium-1-2">
                              <div class="uk-overflow-container">
                                <table>
                                        ...
                                        <tr>
                                            <td align=""> <div  align="right" class="uk-text-primary">Amount to deposit GHC</div></td>
                                        <td>
